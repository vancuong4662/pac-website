...
INSERT INTO products (
    ...
    'Test Hướng nghiệp PAC',
    'test-huong-nghiep-pac',
    'Khám phá tính cách và định hướng nghề nghiệp phù hợp với bạn',
    '<h3>🧠 Giới thiệu</h3>
    ...
    '14-22 tuổi',
    'assets/img/pic/career-test.jpg',
    'active',
    1
);
...
INSERT INTO product_packages (
    ...
    original_price, sale_price, is_free, special_features, sort_order
) VALUES (
...
-- 4. SẢN PHẨM: TƯ VẤN CV VÀ PHỎNG VẤN
INSERT INTO products (
    name, slug, short_description, full_description, type, category,
    duration, target_audience, learning_outcomes,
    instructor_info, teaching_format, image_url, status, sort_order
...
INSERT INTO products (
    ...
    'both',
    'assets/img/pic/career-expert-consultation.jpg',
    'active',
    5
);
